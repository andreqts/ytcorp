...
listSetores = [
    ...
    'FABRICANTES/FORNECEDORES DE EQUIPAMENTOS E TECNOLOGIA'
]
...
listPalestrantes = [
    ...
    ('BERNARDO MARANGON', [St.COMERCIALIZACAO, St.FORNECEDORES], 'EXATA ENERGIA', 14),
    ...
    ('CLAUDIO ELIAS CARVALHO', [St.FORNECEDORES], 'VOLT ROBOTICS', 24),
    ...
    ('DONATO DA SILVA FILHO', [St.FORNECEDORES], 'VOLT ROBOTICS', 20),
    ...
    ('EWERTON GUARNIER', [St.FORNECEDORES], 'VOLT ROBOTICS', 16),
    ...
    ('GABRIELLA REIGADA', [St.FORNECEDORES], 'Grupo GNHR', 8),
    ...
    ('MARCO TOGNIAZZOLO', [St.FORNECEDORES], 'BESSware Soluções / SEC POWER', 26),
    ...
    ('ROBERTO VALER', [St.FORNECEDORES], 'HUAWEI', 19),
